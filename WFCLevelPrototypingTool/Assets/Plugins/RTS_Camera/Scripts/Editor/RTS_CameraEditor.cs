    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void RotationTab()
        {
            ...
            if(camera.useMouseRotation) {
                ...
                camera.pivotAround = EditorGUILayout.ObjectField("Pivot", camera.pivotAround, typeof(GameObject), true) as GameObject;
                camera.radius = EditorGUILayout.FloatField("Camera radius", camera.radius);
            }
        }
